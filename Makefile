...
##@ Backups  (step 13–15; S3 bucket via Terraform + CNPG WAL/base + Redis RDB backups)
...
##@ Data recovery  (CNPG — two tiers: reattach the retained PV, or restore from S3; Redis — restore from S3)
.PHONY: recover-cnpg
